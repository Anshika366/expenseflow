    ...
    <div className="lg:col-span-12 grid grid-cols-1 lg:grid-cols-2 gap-6 text-left items-stretch">
      ...
      <div className="group relative bg-white/95 dark:bg-[#0B0F19]/90 backdrop-blur-xl border border-slate-200/90 dark:border-slate-800/90 p-5 sm:p-7 md:p-8 rounded-[28px] sm:rounded-[36px] shadow-sm hover:shadow-[0_20px_50px_rgba(99,102,241,0.15)] dark:hover:shadow-[0_20px_50px_rgba(99,102,241,0.25)] hover:border-indigo-400/40 dark:hover:border-indigo-500/40 transition-all duration-500 text-left flex flex-col justify-between overflow-hidden h-full min-h-[390px]">
        ...
        <div className="space-y-5 relative z-10 flex-1 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between gap-2 pb-4 border-b border-slate-100 dark:border-slate-800/80 mb-4">
            ...
            {categorySummary.length === 0 ? (
              ...
              <div className="space-y-1">
                <div className="max-h-[240px] overflow-y-auto pr-1.5 space-y-3 custom-scrollbar">
          ...
          {hasMore && (
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800/80 relative z-10 flex justify-center mt-3">
              <button
      ...
      <div className="group relative bg-white/95 dark:bg-[#0B0F19]/90 backdrop-blur-xl border border-slate-200/90 dark:border-slate-800/90 p-5 sm:p-7 md:p-8 rounded-[28px] sm:rounded-[36px] shadow-sm hover:shadow-[0_20px_50px_rgba(59,130,246,0.15)] dark:hover:shadow-[0_20px_50px_rgba(59,130,246,0.25)] hover:border-blue-400/40 dark:hover:border-blue-500/40 transition-all duration-500 text-left flex flex-col justify-between overflow-hidden h-full min-h-[390px]">
        ...
        <div className="space-y-5 relative z-10 flex-1 flex flex-col justify-between">
          ...
          {maxWeeklyAmount === 0 ? (
            ...
            <div className="h-52 flex items-end justify-between gap-2 sm:gap-3.5 pt-4">
              {weeklyData.map((w) => {
                const heightPercent =

...
export default function Reports() {
  ...
  if (isReportsStatementPage) {
    return (
      <div className="space-y-7 pb-12 text-left font-sans text-slate-800 dark:text-slate-100 max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800/90 ring-1 ring-slate-900/5 dark:ring-white/10 p-6 rounded-[28px] shadow-sm relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-2.5 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-[#5B4CFF] to-[#3B82F6] hover:from-[#4C3DE6] hover:to-[#2563EB] text-white rounded-2xl text-xs font-black shadow-lg shadow-indigo-500/25 hover:shadow-2xl hover:shadow-indigo-500/45 hover:-translate-y-0.5 cursor-pointer transition-all"
            >
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-5 py-3 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-100 rounded-2xl text-xs font-black border border-slate-200 dark:border-slate-700 cursor-pointer transition-all hover:-translate-y-0.5"
            >
              <Printer size={16} />
        ...
        <div className="bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800/90 ring-1 ring-slate-900/5 dark:ring-white/10 rounded-[28px] p-6 md:p-7 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div className="group relative overflow-hidden bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 rounded-2xl p-5 hover:border-rose-500/60 dark:hover:border-rose-500/60 hover:shadow-[0_15px_35px_rgba(244,63,94,0.2)] hover:-translate-y-1 transition-all duration-300 cursor-pointer flex items-center justify-between">
              ...
              <div className="w-10 h-10 rounded-2xl bg-rose-50 dark:bg-rose-950/60 text-rose-500 flex items-center justify-center border border-rose-100 dark:border-rose-900/40">
                  ...
                  filteredExpenses.map((exp, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-4 px-4 font-extrabold text-slate-900 dark:text-white group-hover:text-[#5B4CFF] transition-colors">
                        ...
                        <td className="py-4 px-4 text-[#5B4CFF] dark:text-indigo-300 font-extrabold">
                          {exp.date || "N/A"}
                        </td>
                        <td className="py-4 px-4 text-slate-600 dark:text-slate-300 font-bold">
                          {exp.paymentMethod || exp.method || "Cash"}
                        </td>
                        <td className="py-4 px-4 text-right font-black text-rose-500 text-sm">
  ...
  return (
    <div className="space-y-8 pb-12 text-left max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-[#0B0F19] border border-slate-200/80 dark:border-slate-800/80 p-7 md:p-8 rounded-[32px] shadow-sm text-left flex flex-col justify-between space-y-7 relative overflow-hidden">
          ...
          <div className="p-4 bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100/80 dark:border-indigo-900/40 rounded-2xl relative z-10 shadow-sm">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-[#0B0F19] border border-slate-200/80 dark:border-slate-800/80 p-7 md:p-8 rounded-[32px] shadow-sm text-left flex flex-col space-y-7 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between pb-5 border-b border-slate-100 dark:border-slate-800/80 relative z-10 mb-2">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 text-emerald-500 flex items-center justify-center border border-emerald-100 dark:border-emerald-900/40 shadow-sm">
                <FileText size={18} />
              </div>
              <div>
                <h2 className="font-extrabold text-sm uppercase tracking-wider text-slate-900 dark:text-white">
                ...
                {[...expenses]
                  ...
                  .map((exp, index) => {
                    ...
                    return (
                      <div
                        key={exp.id || index}
                        className="p-4 bg-slate-50/90 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800/60 rounded-2xl flex items-center justify-between shadow-sm group hover:border-[#5B4CFF]/50 dark:hover:border-indigo-500/50 hover:shadow-[0_8px_30px_rgba(91,76,255,0.12)] dark:hover:shadow-[0_8px_30px_rgba(91,76,255,0.2)] hover:-translate-y-1 transition-all duration-300 cursor-pointer"
                      >
                        <div className="flex items-center gap-4">
                          <div
                            className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg shadow-sm border ${catInfo.style}`}
                          >
                            {catInfo.icon}
                          </div>
                          <div>
                        ...
                        <span className="font-extrabold text-slate-900 dark:text-white group-hover:text-rose-500 transition-colors">
                          ₹{Number(exp.amount || 0).toLocaleString("en-IN")}
                        </span>
                      </div>
                    );

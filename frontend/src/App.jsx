...
function AppLayout({ darkMode, setDarkMode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#FAFAFD] dark:bg-[#050816] text-slate-900 dark:text-[#E5E7EB] font-sans transition-colors duration-500 overflow-x-hidden selection:bg-[#5B4CFF]/30 selection:text-[#5B4CFF] p-5 md:p-6 gap-5 items-stretch">
      <div className="hidden lg:flex flex-col shrink-0 self-stretch min-h-full">
